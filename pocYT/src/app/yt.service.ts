...
export class YtService {
  ...
  getPlaylistItems(playlistId: string): Observable<PlaylistItemListResponse> {
    ...
    return this.http.get<PlaylistItemListResponse>(this.ytPlaylistItemsUrl + '?key=AIzaSyDmBnFCo-4j1EN9-ZCf_RZtgds-Eeweqoc&part=snippet&playlistId=' + playlistId + '&maxResults=50&pageToken=' + this.playlistItemPageToken, httpOptions).pipe(catchError(this.handleError));
  ...
  getPlaylistItem(id: string): Observable<PlaylistItemListResponse> {
    ...
    return this.http.get<PlaylistItemListResponse>(this.ytPlaylistItemsUrl + '?key=AIzaSyDmBnFCo-4j1EN9-ZCf_RZtgds-Eeweqoc&part=snippet&id=' + id, httpOptions).pipe(catchError(this.handleError));
